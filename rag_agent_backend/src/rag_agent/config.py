...
# Absolute path to rag_agent_backend/ — resolved from this file's location so
# CHROMA_DIR and DATA_DIR work regardless of the working directory when the
# API or CLI is launched.
# config.py is at: rag_agent_backend/src/rag_agent/config.py
#   parents[0] → src/rag_agent/
#   parents[1] → src/
#   parents[2] → rag_agent_backend/
...
# --- Paths ---
# Absolute paths so the API and CLI work from any working directory.
CHROMA_DIR = str(_BACKEND_DIR / "chroma_store")

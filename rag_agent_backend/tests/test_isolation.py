...
from rag_agent.ingestion.ingest import ingest
from rag_agent.retrieval.query import retrieve
...
def populated_collection(tmp_path_factory, embed_model):
    ...
    with (
        ...
        patch("rag_agent.ingestion.ingest.load_pdf", side_effect=_fake_load_pdf),
    ):
